...
public class EmployeeServiceImpl implements com.crowdfunding.core.service.IEmployeeService {
	...
	public Result<String> addEmployee(Employee employee) {
		...
		try{
			//判断参数不能为空
			BasisUtil.validParamsNotNull(employee.getRoleId(),employee.getName(),employee.getPassword(),employee.getRepassword());
			//判断密码是否一致
