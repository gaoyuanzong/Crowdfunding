...
<style type="text/css"> 
    ...
    .space{ color:#E7E7E7;}
    /* 顶部 */ 
    .l-topmenu{ margin:0; padding:0; height:31px; line-height:31px; background:url(${basePath}image/topbg.gif) repeat-x left bottom #2f69b5;  position:relative; border-top:1px solid #1D438B;  }
...
<div id="layout1" style="width:99.3%; margin:0 auto; margin-top:4px; "> 
		<div position="left"  title="后台管理系统" id="leftMenu">
