...
<head>
	...
	<script type="text/javascript">
		function cfIntegral_edit_submit(dialog){
			$("#crowdfunding_cfIntegral_edit_form").submit();
		}
		
		$(document).ready(function(){
			 $("#crowdfunding_cfIntegral_edit_form").validate({
			 	submitHandler : function(frm){
					commonFrmSubmit(
						"#crowdfunding_cfIntegral_edit_form",
						basePath+"admin/crowdfunding/cfIntegral!doEdit.action",
						function(json){
							if(json.success){
								home_fresh();
							}else{
...
<body>
 	<form id="crowdfunding_cfIntegral_edit_form" name="crowdfunding_cfIntegral_edit_form" class="l-form" method="post">
