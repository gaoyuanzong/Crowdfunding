...
<head>
	...
	<script type="text/javascript">
		function projectSubscribe_edit_submit(dialog){
			$("#crowdfunding_projectSubscribe_edit_form").submit();
		}
		
		$(document).ready(function(){
			 $("#crowdfunding_projectSubscribe_edit_form").validate({
			 	submitHandler : function(frm){
					commonFrmSubmit(
						"#crowdfunding_projectSubscribe_edit_form",
						basePath+"admin/crowdfunding/projectSubscribe!doEdit.action",
						function(json){
							if(json.success){
								home_fresh();
							}else{
...
<body>
 	<form id="crowdfunding_projectSubscribe_edit_form" name="crowdfunding_projectSubscribe_edit_form" class="l-form" method="post">
