...
<head>
	...
	<script type="text/javascript">
		function cfDiscount_edit_submit(dialog){
			$("#crowdfunding_cfDiscount_edit_form").submit();
		}
		
		$(document).ready(function(){
			 $("#crowdfunding_cfDiscount_edit_form").validate({
			 	submitHandler : function(frm){
					commonFrmSubmit(
						"#crowdfunding_cfDiscount_edit_form",
						basePath+"admin/crowdfunding/cfDiscount!doEdit.action",
						function(json){
							if(json.success){
								home_fresh();
							}else{
...
<body>
 	<form id="crowdfunding_cfDiscount_edit_form" name="crowdfunding_cfDiscount_edit_form" class="l-form" method="post">
