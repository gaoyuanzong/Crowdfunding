...
<head>
	...
	<script type="text/javascript">
		function cfLoginlog_edit_submit(dialog){
			$("#crowdfunding_cfLoginlog_edit_form").submit();
		}
		
		$(document).ready(function(){
			 $("#crowdfunding_cfLoginlog_edit_form").validate({
			 	submitHandler : function(frm){
					commonFrmSubmit(
						"#crowdfunding_cfLoginlog_edit_form",
						basePath+"admin/crowdfunding/cfLoginlog!doEdit.action",
						function(json){
							if(json.success){
								home_fresh();
							}else{
...
<body>
 	<form id="crowdfunding_cfLoginlog_edit_form" name="crowdfunding_cfLoginlog_edit_form" class="l-form" method="post">
