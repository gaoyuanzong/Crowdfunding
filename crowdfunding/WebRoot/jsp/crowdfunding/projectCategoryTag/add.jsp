...
<head>
	...
	<script type="text/javascript">
		function projectCategoryTag_add_submit(dialog){
			$("#crowdfunding_projectCategoryTag_add_form").submit();
		}
		
		$(document).ready(function(){
			 $("#crowdfunding_projectCategoryTag_add_form").validate({
			 	submitHandler : function(frm){
					commonFrmSubmit(
							"#crowdfunding_projectCategoryTag_add_form",
...
<body>
 	<form id="crowdfunding_projectCategoryTag_add_form" name="crowdfunding_projectCategoryTag_add_form" class="l-form" method="post">
