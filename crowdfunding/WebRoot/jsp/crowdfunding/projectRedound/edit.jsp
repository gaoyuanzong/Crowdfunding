...
<head>
	...
	<script type="text/javascript">
		function projectRedound_edit_submit(dialog){
			$("#crowdfunding_projectRedound_edit_form").submit();
		}
		
		$(document).ready(function(){
			 $("#crowdfunding_projectRedound_edit_form").validate({
			 	submitHandler : function(frm){
					commonFrmSubmit(
						"#crowdfunding_projectRedound_edit_form",
						basePath+"admin/crowdfunding/projectRedound!doEdit.action",
						function(json){
							if(json.success){
								home_fresh();
							}else{
...
<body>
 	<form id="crowdfunding_projectRedound_edit_form" name="crowdfunding_projectRedound_edit_form" class="l-form" method="post">
