...
<head>
	...
	<script type="text/javascript">
		function cfMoneyRecord_edit_submit(dialog){
			$("#crowdfunding_cfMoneyRecord_edit_form").submit();
		}
		
		$(document).ready(function(){
			 $("#crowdfunding_cfMoneyRecord_edit_form").validate({
			 	submitHandler : function(frm){
					commonFrmSubmit(
						"#crowdfunding_cfMoneyRecord_edit_form",
						basePath+"admin/crowdfunding/cfMoneyRecord!doEdit.action",
						function(json){
							if(json.success){
								home_fresh();
							}else{
...
<body>
 	<form id="crowdfunding_cfMoneyRecord_edit_form" name="crowdfunding_cfMoneyRecord_edit_form" class="l-form" method="post">
