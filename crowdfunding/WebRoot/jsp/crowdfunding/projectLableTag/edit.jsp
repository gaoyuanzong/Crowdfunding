...
<head>
	...
	<script type="text/javascript">
		function projectLableTag_edit_submit(dialog){
			$("#crowdfunding_projectLableTag_edit_form").submit();
		}
		
		$(document).ready(function(){
			 $("#crowdfunding_projectLableTag_edit_form").validate({
			 	submitHandler : function(frm){
					commonFrmSubmit(
						"#crowdfunding_projectLableTag_edit_form",
...
<body>
 	<form id="crowdfunding_projectLableTag_edit_form" name="crowdfunding_projectLableTag_edit_form" class="l-form" method="post">
